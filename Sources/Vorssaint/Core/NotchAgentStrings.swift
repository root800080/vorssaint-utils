...
extension NotchAgentStrings {
    static let enUS = NotchAgentStrings(
        ...
        closestToLimit: "Closest to 100%",
        showWindowLetter: "Show S or W before the percentage",
        limitAt: "Warn at",
    ...
    static let ptBR = NotchAgentStrings(
        ...
        closestToLimit: "Mais perto de 100%",
        showWindowLetter: "Mostrar S ou W antes da porcentagem",
        limitAt: "Avisar em",
    ...
    static let es = NotchAgentStrings(
        ...
        closestToLimit: "Más cercano al 100%",
        showWindowLetter: "Mostrar S o W antes del porcentaje",
        limitAt: "Avisar al",
    ...
    static let de = NotchAgentStrings(
        ...
        closestToLimit: "Am nächsten an 100 %",
        showWindowLetter: "S oder W vor dem Prozentwert zeigen",
        limitAt: "Warnen bei",
    ...
    static let fr = NotchAgentStrings(
        ...
        waitingAlert: "Claude attend ta réponse",
        closestToLimit: "Le plus proche de 100 %",
        showWindowLetter: "Afficher S ou W avant le pourcentage",
        limitAt: "Avertir à",
    ...
    static let it = NotchAgentStrings(
        ...
        closestToLimit: "Più vicino al 100%",
        showWindowLetter: "Mostra S o W prima della percentuale",
        limitAt: "Avvisa al",
    ...
    static let ru = NotchAgentStrings(
        ...
        closestToLimit: "Ближе всего к 100%",
        showWindowLetter: "Показывать S или W перед процентом",
    ...
    static let tr = NotchAgentStrings(
        ...
        waitingAlert: "Claude senden bir yanıt bekliyor",
        closestToLimit: "%100’e en yakın",
        showWindowLetter: "Yüzdeden önce S veya W göster",
        limitAt: "Uyarı eşiği",
    ...
    static let ja = NotchAgentStrings(
        ...
        closestToLimit: "100%に最も近い",
        showWindowLetter: "割合の前にSかWを表示",
        limitAt: "通知するしきい値",
        budget: "API換算額の1日の予算",
        off: "オフ",
        updatedFormat: "最終更新：%@",
    ...
    static let ko = NotchAgentStrings(
        ...
        closestToLimit: "100%에 가장 가까움",
        showWindowLetter: "퍼센트 앞에 S 또는 W 표시",
        limitAt: "알림 기준",
    ...
    static let zhHans = NotchAgentStrings(
        ...
        closestToLimit: "最接近 100%",
        showWindowLetter: "在百分比前显示 S 或 W",
        limitAt: "提醒阈值",
        budget: "每日 API 价值预算",
        off: "关闭",
        updatedFormat: "上次更新：%@",
    ...
    static let zhTW = NotchAgentStrings(
        ...
        closestToLimit: "最接近 100%",
        showWindowLetter: "在百分比前顯示 S 或 W",
        limitAt: "提醒門檻",
        budget: "每日 API 價值預算",
        off: "關閉",
        updatedFormat: "上次更新：%@",
    ...
    static let zhHK = NotchAgentStrings(
        ...
        waitingAlert: "Claude 正在等你回覆",
        closestToLimit: "最接近 100%",
        showWindowLetter: "喺百分比前顯示 S 或 W",
        limitAt: "提示門檻",
        budget: "每日 API 價值預算",
        off: "關閉",
        updatedFormat: "上次更新：%@",
