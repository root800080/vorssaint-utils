...
extension Strings {
    static let fr = Strings(
        ...
        dimKeyboardOnLidCloseTitle: "Assombrir complètement le rétroéclairage du clavier",
        dimKeyboardOnLidCloseCaption: "Assombrit le rétroéclairage du clavier à la fermeture du couvercle et le restaure à l’ouverture.",
