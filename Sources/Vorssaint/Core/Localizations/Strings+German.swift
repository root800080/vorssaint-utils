...
extension Strings {
    static let de = Strings(
        ...
        dimKeyboardOnLidCloseTitle: "Tastaturbeleuchtung vollständig abdunkeln",
        dimKeyboardOnLidCloseCaption: "Dunkelt die Tastaturbeleuchtung ab, sobald der Deckel geschlossen wird, und stellt sie beim Öffnen wieder her.",
