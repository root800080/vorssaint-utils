...
extension Strings {
    static let ru = Strings(
        ...
        dimKeyboardOnLidCloseTitle: "Полностью затемнять подсветку клавиатуры",
        dimKeyboardOnLidCloseCaption: "Затемняет подсветку клавиатуры при закрытии крышки и восстанавливает её при открытии.",
