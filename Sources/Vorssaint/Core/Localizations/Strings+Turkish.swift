...
extension Strings {
    static let tr = Strings(
        ...
        dimKeyboardOnLidCloseTitle: "Klavye arka ışığını tamamen karart",
        dimKeyboardOnLidCloseCaption: "Kapak kapandığında klavye arka ışığını karartır, açıldığında geri getirir.",
